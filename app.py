...
def show_charts_watch_view():
    ...
    st.markdown(
        ...
        '<div style="font-size:26px;font-weight:900;letter-spacing:0.08em;color:#c8c8ff;">CHARTS TO WATCH</div>'
        '<div style="font-size:11px;color:#4a5a7a;letter-spacing:0.22em;text-transform:uppercase;margin-top:4px;">'
        'E7 Double Bottom · W1 Confirmed · Neckline Touched · Awaiting W2 Retest</div>'
        '</div>',
        unsafe_allow_html=True,
    )
